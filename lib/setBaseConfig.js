...
var AutoInstallNpmPlugin = require('./plugins/AutoInstallNpm');
...
module.exports = function (chainConfig, userConfig, _ref) {
  ...
  var _userConfig$platform = userConfig.platform,
      ...
      _userConfig$virtualHo = userConfig.virtualHost,
      virtualHost = _userConfig$virtualHo === void 0 ? false : _userConfig$virtualHo,
      _userConfig$nativePac = userConfig.nativePackage,
      nativePackage = _userConfig$nativePac === void 0 ? {} : _userConfig$nativePac;
  ...
  chainConfig.plugin('RemoveDefaultPlugin').use(RemoveDefaultPlugin); // Auto install npm for native miniapp

  chainConfig.plugin('AutoInstallNpmPlugin').use(AutoInstallNpmPlugin, [{
